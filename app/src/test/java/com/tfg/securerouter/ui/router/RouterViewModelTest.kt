...
class RouterViewModelTest {
    ...
    fun uiState_initiallyLoading() = runTest {
        val viewModel = RouterViewModel(FakeRouterRepository())
        assertEquals(viewModel.uiState.first(), RouterUiState.Loading)
    }
...
private class FakeRouterRepository : RouterRepository {
