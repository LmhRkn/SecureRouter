...
import com.tfg.securerouter.data.app.screens.wifi.model.send.web_filter.AddFilterWebRuleWifi
import com.tfg.securerouter.data.app.screens.wifi.model.send.web_filter.RemoveFilterWebRuleWifi
...
fun WifiFilterWebTable(
    ...
    GenericRuleTable<WifiFilterWebRuleState, WifiFilterWebsRulesState>(
        ...
        rulesOf = { it.rules },
        encode = { r -> listOf(r.domain, r.index.toString()).joinToString("§") },
        ...
        removeAndShift = { current, toRemove ->
            removeRuleAndShiftGeneric(
                ...
                toRemove = toRemove,
                indexOf = { it.index },
                recalc = { r, newIdx, _ -> r.copy(index = newIdx) },
            )
        },
        onRemoveRemote = { r -> RemoveFilterWebRuleWifi.removeFilterWebRuleWifi(r) },
        AddOrEdit = { oldRule, mac, nextIdx, current, onSave, onCancel, onBumpToEnd, onRemoveRule ->
            AddWifiFilterWeb(
                ...
                saveTextButton = if (oldRule != null)
                ...
                onAddRemote = { r -> AddFilterWebRuleWifi.addFilterWebRuleWifi(r) }
            )
        }
    )
}
