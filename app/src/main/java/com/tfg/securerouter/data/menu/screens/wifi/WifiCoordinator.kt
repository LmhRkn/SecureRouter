package com.tfg.securerouter.data.menu.screens.wifi
...
import com.tfg.securerouter.data.menu.screens.wifi.registry.WifiContentRegistry
...
class WifiCoordinator : ViewModel(), ScreenCoordinatorDefault {
    ...
    val modules: List<ScreenComponentModelDefault> = WifiContentRegistry(sharedCache).modules
