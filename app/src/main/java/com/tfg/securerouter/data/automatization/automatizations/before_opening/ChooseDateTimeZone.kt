...
import com.tfg.securerouter.data.automatization.registry.ChooseDateTimeZone.ChooseDateTimeZoneRegistry
...
class ChooseDateTimeZone(
    ...
    private suspend fun buildPosixForZone(desired: String): String {
        ChooseDateTimeZoneRegistry.knownTimeZones[desired]?.let { return it }
